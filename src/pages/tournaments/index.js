...
import YoutubeIcon from "../../Assets/youtubebtn.png";
...
function Tournaments() {
  ...
  return (
    <>
      <Head>
        <title content={"Tournaments"} />
        <title>Tournaments</title>
        <meta
          name="keywords"
          content="Wave Game Tournaments | Ludo Tournaments | Gaming | Wave Game.in  Tournaments | wavegame.in  Tournaments| Wave Game Jaipur  Tournaments"
        />
